...
5. Download your school's customized ZIP package and deploy it to any static host (GitHub Pages, Netlify, etc.).

## ✨ Features

- 📱 **Mobile-First Judging**: Optimized for tablets and phones.
- ⏱️ **Integrated Timers**: Keep competitions on track with per-speech timers.
- 📊 **Real-time Results**: Instant ranking and CSV exports.
- 🎨 **White-label Branding**: Customize colors, logos, and criteria.
- 🏆 **Winner Screen**: A dedicated display view for projectors/stages.
- 🔌 **Supabase Powered**: Fast, secure, and free backend.

## 🛠️ Developer Setup

If you want to contribute or modify the core code:

1. Clone the repository.
2. Serve the directory using any local server (e.g., `npx serve`).
3. Modify `app.js` and `styles.css` for custom logic/design.
